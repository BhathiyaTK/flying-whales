<template>
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                <p class="google-font mt-2 mb-0" style="font-size:170%;color:#37474F;" >Our Partners and Collaborators</p>
                                ...
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:4px;border-width: 0px; border-style: solid;">
                                        ...
                                        <a v-bind:href="item.link" target="_blank" >
                                            ...
                                            :lazy-src="getImgUrl(item.imgSrc)"
                                            aspect-ratio="2.5"
                                            class="white"
                                            v-on="on"
                                            contain>
                                            ...
                                            <span class="google-font">{{item.id}}</span>
                                            </v-tooltip>
                                        </a>
...
export default {
    ...
    methods:{
        getImgUrl(pic) {
            return require('@/assets/img_/partners/'+pic)
        },
    }
}
</script>